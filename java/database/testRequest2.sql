SELECT play_dates.meeting_date, play_dates.start_time, play_dates.duration, play_dates.location_street_address, 
...
JOIN user_pet ON pets.pet_id=user_pet.pet_id WHERE user_id = 16 AND request.status_id = 2;